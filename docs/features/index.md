...
Roux is built around terminal-first agent work: sessions keep work isolated, panes keep related processes visible, and the Library keeps reusable prompts and skills close to the terminal where you need them.
...
- [CLI](cli.md) — drive sessions, panes, notes, and notifications from `roux-cli`.
