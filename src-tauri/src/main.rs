...
fn main() {
    ...
    let builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        commands::settings::cmd_validate_kanban_workflow,
        commands::settings::cmd_kanban_workflow_config_dir,
        commands::settings::cmd_create_kanban_workflow_example,
        commands::settings::cmd_save_kanban_workflow_json,
        ...
        commands::work_items::work_item_archive,
        commands::work_items::work_item_restore,
        commands::work_items::work_item_attach_session,
        commands::work_items::work_item_detach_session,
        commands::work_items::work_item_plan,
        commands::work_items::work_item_run_stage,
        commands::work_items::work_item_review_accept,
        commands::work_items::work_item_review_request,
        commands::work_items::work_item_review_request_changes,
