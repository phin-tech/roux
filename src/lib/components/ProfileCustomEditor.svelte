  ...
  >
    ...
    >
      <div class="border-b border-hairline bg-bg-surface/30 px-6 pt-5 pb-4">
        <h2 class="mb-1 text-base font-semibold tracking-tight text-text-primary">Custom spawn profile</h2>
        <p class="text-xs text-text-muted">One-shot recipe for this pane. Save it to settings to reuse later.</p>
      </div>

      <div class="flex flex-col gap-4 px-6 py-5">
        <div class="flex flex-col gap-1.5">
          <label for="profile-custom-name" class="text-[11px] font-semibold uppercase tracking-wider text-text-muted">
            Name <span class="font-normal normal-case tracking-normal">(optional)</span>
          </label>
          <input
        ...
        <div class="flex flex-col gap-1.5">
          <label for="profile-custom-setup" class="text-[11px] font-semibold uppercase tracking-wider text-text-muted">
            Setup command <span class="font-normal normal-case tracking-normal">(optional, runs first)</span>
          </label>
          <input
        ...
        <div class="flex flex-col gap-1.5">
          <label for="profile-custom-startup" class="text-[11px] font-semibold uppercase tracking-wider text-text-muted">
            Startup command
          </label>
          <input
        ...
        <label class="flex items-center gap-2.5 cursor-pointer group">
          <input
            ...
            onchange={(e) => (startupBehavior = (e.currentTarget as HTMLInputElement).checked ? "typeOnly" : "autoRun")}
