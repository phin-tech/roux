...
export const THEME_DEFINITIONS: ThemeDefinition[] = [
  ...
  {
    id: "warm-burnout-dark",
    label: "Warm Burnout",
    description: "Warm umber backgrounds with burnt-sienna accents.",
  },
  {
    id: "warm-burnout-light",
    label: "Warm Burnout Light",
    description: "Warm parchment with burnt-sienna accents.",
    light: true,
  },
];
...
export const TERMINAL_THEME_DEFINITIONS: TerminalThemeDefinition[] = [
  ...
  { id: "github-light", label: "GitHub Light", category: "editor" },
  { id: "one-light", label: "One Light", category: "editor" },
  { id: "catppuccin-latte", label: "Catppuccin Latte", category: "editor" },
  { id: "tokyo-night-day", label: "Tokyo Night Day", category: "editor" },
  { id: "gruvbox-light", label: "Gruvbox Light", category: "editor" },
  { id: "tomorrow", label: "Tomorrow", category: "editor" },
